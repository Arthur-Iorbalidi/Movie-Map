...
const DetailedDirector = () => {
  ...
  useEffect(() => {
    (async () => {
      setIsLoading(true);
      const data = await serverAPI.getDirector(Number(id), errorCallback);
      setDirector(data);
      setIsLoading(false);
    })();
  }, []);
  ...
  const handleToggleFavorite = (
    ...
    toggleFavoriteDirector(
      director!.id,
      isInArray(director!.id, favoritesDirectors),
      succesAdd,
      succesRemove,
      unathorizedCallback,
    );
          ...
          <div className={styles.img_info}>
            <div className={styles.img_wrapper}>
              ...
              <div className={styles.favourite_btn_wrapper}>
                <FavoriteButton
                  isInFavorites={isInArray(director.id, favoritesDirectors)}
